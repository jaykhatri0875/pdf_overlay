...
from utils.common_types import BoundingBox
from utils.geometry import resolve_enclosing_bbox, resolve_enclosing_rbbox
from utils.repr import NestedObject
from utils.visualization import synthesize_kie_page, synthesize_page, visualize_kie_page, visualize_page
...
class KIEPage(Element):
    ...
    def export_as_xml(self, file_title: str = "docTR - XML export (hOCR)") -> Tuple[bytes, ET.ElementTree]:
        ...
        SubElement(
            head,
            "meta",
            attrib={"name": "ocr-system", "content": "python-doctr 1.0.0"},  # type: ignore[attr-defined]
        )
        SubElement(
            head,
            "meta",
